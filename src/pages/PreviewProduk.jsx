        ...
        <div className="flex flex-col md:flex-row md:max-w-screen-lg md:mx-auto md:mt-12">
            ...
            <div className="px-4 flex flex-col relative bottom-2 gap-4 md:flex-grow md:bottom-0">
                <div className="bg-white rounded-xl px-6 py-4 flex flex-col shadow-low md:shadow-high">
                    ...
                    <button 
                        className="hidden md:block w-full bg-purple-4 hover:bg-purple-5 font-medium text-white text-center py-2 mt-4 rounded-[16px] focus:ring-2 focus:ring-offset-2 focus:ring-purple-4 focus:outline-none"
                        disabled={ isLoading } 
                    ...
                    <button 
                        className="hidden md:block w-full border border-purple-4 bg-white font-medium text-neutral-5 text-center py-2 mt-4 rounded-2xl"
                        disabled={ isLoading }
                        onClick={ () => navigate(location.state?.prevPathname || -1, { state: location.state }) } 
                    >
                        Edit
